"""
M3: ROI Detection Pipeline - Batch Process All Aligned Images
Process all 6256 aligned images using roi_boundingbox.pt (YOLOv8n)
"""
import os
import sys
import codecs
...
# Configuration
INPUT_DIR = Path(r"F:\Workspace\Project\data\m2_crops_aligned")
OUTPUT_DIR = Path(r"F:\Workspace\Project\data\m3_roi_crops_all")
RESULTS_CSV = Path(r"F:\Workspace\Project\data\m3_roi_results_all.csv")
...
print("=" * 70)
print("M3: ROI DETECTION - BATCH PROCESS ALL ALIGNED IMAGES")
print("=" * 70)
...
print(f"\n[SCAN] Found {len(image_files)} aligned images")
